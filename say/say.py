    ...
    async def say(
        ...
        if not channel.permissions_for(ctx.guild.me).send_messages:
            if channel != ctx.channel:
                ...
                await ctx.author.send(_("I am not allowed to send messages in ") + channel.mention)
    ...
    async def _saydelete(
        ...
        try:
            ...
            try:
                ...
                await ctx.author.send(_("Not enough permissions to delete messages."), delete_after=15)
